	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Livraison</h3>
		...
		<tr>
			...
			<td> 
				...
				<form method="POST" action="supprimerCommande.php">
					<input type="submit" name="supprimer" value="annuler la livraison"  >
					<input type="hidden" value="<?PHP echo $row['Id_commande']; ?>" name="Id_commande"> <!--onclick="verifier"-->
				</form>
            </td>
